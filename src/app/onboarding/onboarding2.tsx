...
const DOTS = [0, 1, 2]; // three onboarding steps
...
export default function OnboardingScreen2() {
  ...
  const player = useVideoPlayer(
    require("@/assets/images/vid2.mp4"),
    (player) => {
      player.loop = true;
      player.play();
    },
    ...
    <View style={[styles.safe, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.card, { backgroundColor: colors.card }]}>
        ...
        <Text style={[styles.body, { color: colors.textSecondary }]}>
          Stay ahead of the competition by discovering emerging trends, growing
          markets, and consumer interests before they become mainstream
          opportunities.
        </Text>
